...
public class SendRefuseAction extends SendMessageAction {
	 public SendRefuseAction()
	  {
		    setCode("SendRefuse");		    
		    setBtnName("发送婉拒通知");
		    putValue("ShortDescription", "发送婉拒通知");
	  }
	  ...
	  public void doAction(ActionEvent e) throws Exception
	  {
		    ...
		    if (selectDatas==null||selectDatas.length == 0) {
			      throw new BusinessException("所选的面试未通过人员为空，不能发送婉拒通知");
			}
			...
			for(Object selectData:selectDatas){
				 ...
				 if ((aggvo == null) || (StringUtils.isEmpty(aggvo.getInterviewVO().getPk_psndoc()))) {
				      throw new BusinessException("所选的面试未通过人员信息无效，不能发送婉拒通知");
				    }
				    ...
				    messageVO.setMsgrescode("602117");
				    ...
				    //aggvo = ((FailInterviewAppModel)getModel()).sendMessageFlag(aggvo);
				    //((FailInterviewAppModel)getModel()).directlyUpdate(aggvo);
			       putValue("message_after_action", "发送婉拒通知成功");
			}	  	  		  
	...
	public FailInterviewAppModel getApplyModel() { return (FailInterviewAppModel)getModel(); }	
